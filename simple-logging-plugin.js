 ...
 */
class SimpleLoggingPlugin extends BasePlugin {
  constructor(config = {}) {
    const defaultConfig = {
      enabled: true,
      ...
      logLevel: 'info', // Minimum log level to output ('debug', 'info', 'warn', 'error')
      colorize: true, // Use colors in console output
      prefix: '[HED]', // Hasura Event Detector prefix
      ...config
    };
...
module.exports = { SimpleLoggingPlugin };